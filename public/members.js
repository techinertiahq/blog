Array.prototype.forEach.call(document.querySelectorAll('form[data-members-form]'), function (form){
    ...
    function submitHandler(event) {
        ...
        fetch('https://techinertia.com/ghost/api/canary/members/send-magic-link/', {
            method: 'POST',
            headers: {
...
Array.prototype.forEach.call(document.querySelectorAll('[data-members-plan]'), function (el) {
    ...
    function clickHandler(event) {
        ...
        fetch('https://techinertia.com/members/ssr', {
            ...
            return fetch('https://techinertia.com/ghost/api/canary/members/create-stripe-checkout-session/', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
...
Array.prototype.forEach.call(document.querySelectorAll('[data-members-cancel-subscription]'), function (el) {
    ...
    function clickHandler(event) {
        ...
        return fetch('https://techinertia.com/members/ssr', {
            credentials: 'same-origin'
        }).then(function (res) {
            if (!res.ok) {
                return null;
            ...
            return fetch(`https://techinertia.com/ghost/api/canary/members/subscriptions/${subscriptionId}/`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
